...
export default function LatestClipsPage() {
  ...
  const { data: allClipsData = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      console.log('[Latest Clips] Received clips:', clips.length);
      return clips;
    },
  });
                ...
                return (
                  <TouchableOpacity
                    style={[
                      ...
                      selectedGame === (itemId ? itemId.toString() : null) && styles.gameFilterThumbnailActive,
                    ]}
                    onPress={() => {
                      if (!hasContent) {
                  ...
                  >
                    {!itemId ? (
                      ...
                      <View style={styles.thumbnailWrapper}>
                        ...
                        {selectedGame === (itemId ? itemId.toString() : null) && (
                    ...
                    <View style={styles.gameThumbnailInfo}>
                      <Text 
                        style={[
                          ...
                          selectedGame === (itemId ? itemId.toString() : null) && styles.gameThumbnailNameActive
                        ]} 
                        numberOfLines={2}
                      >
                        {item.name}
                      ...
                      <Text style={[
                        ...
                        selectedGame === (itemId ? itemId.toString() : null) && styles.gameThumbnailCountActive
                      ]}>
